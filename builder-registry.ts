  ...
  inputs: [
    {
      ...
      type: "list",
      subFields: [
        { name: "heading", type: "longText", defaultValue: "Into robotics?" },
        {
          name: "subheading",
          type: "longText",
          defaultValue: "Nemo shows you the smartest movers.",
        },
        {
          name: "mediaType",
          type: "string",
